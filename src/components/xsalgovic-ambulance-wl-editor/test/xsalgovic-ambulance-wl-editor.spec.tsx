...
import { XsalgovicAmbulanceWlEditor } from "../xsalgovic-ambulance-wl-editor";
...
describe("xsalgovic-ambulance-wl-editor", () => {
  ...
  it("buttons shall be of different type", async () => {
    ...
    const page = await newSpecPage({
      components: [XsalgovicAmbulanceWlEditor],
      html: `<xsalgovic-ambulance-wl-editor entry-id="test-entry"
           ambulance-id="test-ambulance" api-base="http://sample.test/api"></xsalgovic-ambulance-wl-editor>`,
    });
    await delay(300);
    await page.waitForChanges();
    let items: any = await page.root.shadowRoot.querySelectorAll(
      "md-filled-button"
    );
    ...
    items = await page.root.shadowRoot.querySelectorAll(
  ...
  it("first text field is patient name", async () => {
    ...
    const page = await newSpecPage({
      components: [XsalgovicAmbulanceWlEditor],
      html: `<xsalgovic-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></<pfx>-ambulance-wl-editor>`,
    });
    let items: any = await page.root.shadowRoot.querySelectorAll(
